...
import img1 from "../../../../public/shopitem/unsplash_90HdOlGbjck.png"
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-6 py-10 max-w-6xl mx-auto">
        <div>
         ...
         <div>
          ...
          <h2 className="text-3xl font-bold text-primaryColor mb-4">Dessert</h2>
            ...
            {[
              ...
              <div key={index} className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-[13px] font-normal text-white hover:text-primaryColor">{item.description}</p>
                  </div>
